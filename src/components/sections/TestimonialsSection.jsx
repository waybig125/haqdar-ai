      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        <div className="text-center mb-16">
          <AnimatedContainer variant="fadeUp">
            <h2 className="font-urdu text-4xl md:text-5xl font-bold text-foreground mb-7" dir="rtl">
              شہریوں کی آوازیں
            </h2>
            <p className="font-garamond italic text-lg md:text-xl font-bold tracking-widest text-accent uppercase mt-2.5 mb-4">
